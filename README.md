...
Authorization: basic auth with client-id and client-secret; only required in case of `client_secret_basic` authentication method. Header must not be
present in case of `private_key_jwt` authentication method.
