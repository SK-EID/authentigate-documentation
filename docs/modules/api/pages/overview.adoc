...
[CAUTION]
====
When users authenticate via eParaksts, age-related attributes are not provided at this time. Please note that if your service requests age-related attributes and allows authentication through eParaksts using ACR values, these attributes will not be returned in the response.
====
...
[cols="1,^1,^1,^1,^1", options="header", stripes=odd, grid=none, frame=none]
|====
