...
| `acr_values`     | No | Space separated string containing one or more of the following values: `\http://eidas.europa.eu/LoA/high`, `\http://eidas.europa.eu/LoA/substantial`, `mid`, `mid_ee`, `mid_lt`, `sid`, `sid_ee`, `sid_lv`, `sid_lt`, `idcard`, `idcard_ee`, `eparaksts` | Optional value specifying authentication methods to be usable by the end-user. +
...
[[note1]]^1^ _Supported scope values for requesting end-user attributes are as follows:_
